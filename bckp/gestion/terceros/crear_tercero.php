...
<body>
  ...
  <h2>CREAR USUARIO</h2>
	<br>  	
	  ...
	  <FORM name="formulario" onSubmit="return validar(this)" action="validacion_terceroc1.php" method="post" >
   ...
   <font face="Verdana" size="1"><center>(*) Campo Opcional</center></font>
	 ...
	 <h2>CREAR CLIENTE</h2>   
	  ...
	  <FORM name="formulario" onSubmit="return validar(this)" action="validacion_terceroc2.php" method="post" >
	  <TABLE width="100%" border="1" cellpadding="4" cellspacing="4" bgcolor="#FFFFFF" >
		<TR>
		...
		<TR>
		  ...
		  $consulta= mysql_query("select idtercero,nombres_tercero, apellidos_tercero 
			...
			<TD colspan="1"><font size="1" face="Verdana"><strong>COMISION</strong></font><font size="1" face="Verdana">(*)</font><br>
	        	<input type="text" size="5" maxlength="2" name="COMISION">
			</TD>
	         </TR>
   ...
   <font face="Verdana" size="1"><center>(*) Campo Opcional</center></font>
	 ...
	 <h2>CREAR VENDEDOR</h2>   
	  ...
	  <FORM name="formulario" onSubmit="return validar(this)" action="validacion_terceroc3.php" method="post" >
	  <TABLE width="100%" border="1" cellpadding="4" cellspacing="4" bgcolor="#FFFFFF" >
		<TR>
   ...
   <font face="Verdana" size="1"><center>(*) Campo Opcional</center></font>
	 ...
	 <h2>CREAR MENSAJERO</h2>   
	  ...
	  <FORM name="formulario" onSubmit="return validar(this)" action="validacion_terceroc4.php" method="post" >
	  <TABLE width="100%" border="1" cellpadding="4" cellspacing="4" bgcolor="#FFFFFF" >
		<TR>
