...
onMouseOver="MM_swapImage('menu','','<?php echo $path;?>images/menu_gestion2.gif',1)" onMouseOut="MM_swapImgRestore()">  
...
function menu_gestion2($path){ 

?> 
<a href="<?php echo $path;?>menu_consultas.php"  
onMouseOver="MM_swapImage('menu','','<?php echo $path;?>../images/menu_gestion2.gif',1)" 		onMouseOut="MM_swapImgRestore()">  
<img src="<?php echo $path;?>../images/menu_gestion.gif"  
name="menu" border="0" id="menu"> 
</a> 
...
<tr>  
	<td>  
   	<div align="right"> 
	<a href="<?php echo $path;?>index.php" onMouseOver="MM_swapImage('Image3','','<?php echo $path;?>images/salir3.gif',1)" 	onMouseOut="MM_swapImgRestore()">  
...
<tr> 
	...
	<img width="40%" src="<?php echo $path;?>images/logo.gif" border="0"> 
	</td>	 
