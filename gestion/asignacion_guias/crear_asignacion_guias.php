...
<body>
    ...
    <?php	
      if (isset($_SESSION['usuario']))
      {
          ...
          cabecera($usuario,"Asignacion de guias","../../");  
  ...
  <h2>ASIGNAR A SUCURSAL</h2>
	<br>  	
	  ...
	  <FORM name="formulario" onSubmit="return validar(this)" action="validacion_asignacion_guias.php" method="post" >
	  <TABLE width="100%" border="1" cellpadding="4" cellspacing="4" bgcolor="#FFFFFF" >
		  ...
		  $consulta= mysql_query("select idsucursal, nombre_sucursal 
			...
			<TD><font size="1" face="Verdana"><strong>TIPO DE GUIA</strong></font><br>
	       		<input type="radio" name="TIPO_GUIA" value="1" checked> Contado
<input type="radio" name="TIPO_GUIA" value="0"> Credito
			</TD>
			
		</TR>
			
		<TR>
		    <TD><font size="1" face="Verdana"><strong>VALOR INICIAL</strong></font><font size="1" face="Verdana">(*)</font><br>
	        	<input type="text" size="12" maxlength="7" name="TELEFONO">
			</TD>
	        <TD colspan="1"><font size="1" face="Verdana"><strong>CANTIDAD</strong></font><font size="1" face="Verdana">(*)</font><br>
   ...
   <font face="Verdana" size="1"><center>(*) Campo Opcional</center></font>
         ...
         <div class="tabbertab">
	 <h2>ASIGNAR A CLIENTE O PUNTO DE VENTA</h2>
	<br>  	
	  <table border="0" width="100%">
	  <tr>
	  ...
	  <TABLE width="100%" border="1" cellpadding="4" cellspacing="4" bgcolor="#FFFFFF" >
		  ...
		  $consulta= mysql_query("select idsucursal, nombre_sucursal 
                  ...
                  while ($row = mysql_fetch_array($consulta, MYSQL_BOTH)) {
                   ...
                   <option value=<?php echo $row["idsucursal"] ?>><?php echo $row["nombre_sucursal"] ?></option>
                    ...
                    <TD><font size="1" face="Verdana"><strong>CLIENTE O PUNTO DE VENTA</strong></font><br>
		  ...
		  $consulta= mysql_query("select idtercero,nombres_tercero, apellidos_tercero 
                                          ...
                                          and tercero_tipo.tipo_tercero_idtipo_tercero=1 or tercero_tipo.tipo_tercero_idtipo_tercero=4");
                  while ($row = mysql_fetch_array($consulta, MYSQL_BOTH)) {
                   ?>
