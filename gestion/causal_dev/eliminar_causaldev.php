	 ...
	 $consulta = mysql_query("select codigo_causal_devolucion 
         ...
         if ($num>0)
	  {
	   ?>
	    ...
	    <form name="formulario" onSubmit="return validar(this)" action="validacion_causaldev2.php" method="post">
		...
		<TABLE align="center" border="0">
          <TR>
		    <TD align="center"><font size="+1" face="Verdana">No existen CAUSAL DEVOLUCIONes para Eliminar</font></TD> 
	      </TR>
         </TABLE>
		<?php
		}
