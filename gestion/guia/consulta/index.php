...
<html>
  <head>
    ...
    <script language="javascript" type="text/javascript">
      ...
      function buscarGuias()
      {
        ...
        var dataString = 'fecha1=' + fecha1 + '&fecha2=' + fecha2+'&numGuia='+numGuia;
  ...
  <body id="dt_example">
    ...
    <div id="container">
      <fieldset>
        <legend><h2>Busqueda de guias</h2></legend>
        <label>Numero guia:</label>
        <input size='15' id='numGuia' type='text' value='' title="We ask for your age only for statistical purposes." />
