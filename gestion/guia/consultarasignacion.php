...
if ($_REQUEST) {
    ...
    if ($idtercero != "") {
        ...
        $query = "SELECT saldo_asignnacion,asignacion_guias.inicial_asignacion AS desde, asignacion_guias.inicial_asignacion+asignacion_guias.cantidad_asignacion as hasta, fecha_asignacion FROM  asignacion_guias WHERE asignacion_guias.tercero_idtercero = $idtercero";
