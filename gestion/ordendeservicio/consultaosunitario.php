...
<? 
 ...
 $vacio=true;
	...
	$linkcargar="<a href=\'../guia/cargar.php?nombre=$nombres&id=$id\'><img src=\'../../imagenes/cargar.jpg\' /></a>";
	 ...
	 $dataSet=$dataSet."['$wrapini$documento_tercero$wrapfin','$wrapini$nombres_tercero$wrapfin','$wrapini$apellidos_tercero$wrapfin','$wrapini$fechaentrada$wrapfin','$wrapini$numero_orden_servicio$wrapfin','$observacion_orden_servicio','$wrapini$plazo_entrega_orden$wrapfin','$wrapini$unidades$wrapfin','$linkcargar'],";
    }
...
<html>
	<head>
		...
		<script type="text/javascript" charset="utf-8">
			...
			function wo(obj)
			{
				window.open(obj,"Detallecomandas","location=0,toolbar=0,menubar=0,resizable=1,width=900,height=500");
				return false;
			}
		</script>
...
Ordenes de Servicio
             ...
             <a href="addosunitario.php">Crear Orden</a>
             </td></tr></table>
				<br>
               <? if ($vacio)
                {  
