<? 
	...
	$q = strtolower($_GET["q"]);
	$items=array();
	//$tipo_tercero = 5;  // $tipo_tercero 5 - mensajeros
	$tipo_tercero = $_GET["tt"];
   ...
   if ( mysql_num_rows($res2)>0 )
	 ...
	 $items[$filas["idtercero"]."-".$filas["nombres_tercero"]." ".$filas["apellidos_tercero"]] = $filas["nombres_tercero"]." ".$filas["apellidos_tercero"]." ".$filas["documento_tercero"];
