...
if (isset($_POST["idtercero"]) && $_POST["idtercero"] != "")
{
    ...
    $tercero->clave_tercero = $_POST["txtPass"];
    ...
    } elseif ($_POST["idtipotercero"] == 3) //Tipo ALIADO
    {
        ...
        $query = "SELECT idciudad FROM ciudad_tercero ct  WHERE ct.`idtercero` =  $idterceroNew";
        //echo("<br>La query para obtener las ciudades actuales ".$query." <br>");
        $consultaCiu = mysql_query($query);
...
//           echo("<br>-------------<br>");
    ...
    //$pass = $tercero->clave_tercero;
    $cambioPass = "SELECT * FROM tercero t
WHERE idtercero =  $idterceroNew
AND 
clave_tercero = '$tercero->clave_tercero'";
    
    $res = mysql_query($cambioPass);
    $numFiles = mysql_num_rows($res);
    if ($numFiles==0)
    {
        echo("Cambiando el pass ".$cambioPass."<br>");
        $queryCambio = "update tercero set clave_tercero = md5('$tercero->clave_tercero') where  idtercero = $idterceroNew";
        //die("error al agregar una ciudad" . ' ' . mysql_error());
        if(!mysql_query($queryCambio))
        {
            die("no se pudo cambiar el pass");
        }
        else
            $num++;
    }
                        ...
                        <td>	 
                            ...
                            <FORM name="formulario" onSubmit="return validar(this)" action="#" method="post" >
                                ...
                                <TABLE width="100%" border="1" cellpadding="4" cellspacing="4" bgcolor="#FFFFFF" >
                                    ...
                                    <TR>
                                        <TD colspan="2"><font size="1" face="Verdana"><strong>CONTRASE&Ntilde;A</strong></font><font size="1" face="Verdana">(*)</font><br>
                                            <input type="text" name="txtPass" id="txtPass" value="<?php echo $row["clave_tercero"] ?>">                   </TD>
                                    </TR>
