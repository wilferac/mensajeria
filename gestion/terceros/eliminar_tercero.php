...
<body>
    ...
    <?php	
      ...
      cabecera($_SESSION['datosinicio']['usuario_tercero'],"Eliminacion Tercero","../../");  
	 ...
	 $consulta = mysql_query("select documento_tercero 
         ...
         if ($num>0)
	  {
	   ?>
	    ...
	    <form name="formulario" onSubmit="return validar(this)" action="validacion_tercero2.php" method="post">
		...
		<TABLE align="center" border="0">
          <TR>
		    <TD align="center"><font size="+1" face="Verdana">No existen Teceros para Eliminar</font></TD> 
	      </TR>
         </TABLE>
		<?php
		}
