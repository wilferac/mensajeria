...
TableTools.BUTTONS = {
	...
	"copy": {
		...
		"fnComplete": function(nButton, oConfig, flash, text) {
			var
				...
				plural = (len==1) ? "" : "s";
			alert( 'Copiadas '+len+' fila'+plural+' al portapapeles' );
		},
		"fnInit": null,
		"fnCellRender": null
	},
	...
	"print": {
		"sAction": "print",
		"sInfo": "<h6>Imprimir</h6><p>Por favor use la funcion de imprimir de su navegador "+
		  "para imprimir esta tabla. Presione escape cuando finalice.",
		"sMessage": "",
		"bShowAll": true,
 ...
 */
TableTools.DEFAULTS = {
	"sSwfPath":		 "../../media/media/swf/copy_cvs_xls_pdf.swf",
	"sRowSelect":	   "none",
